- [이진규의 Profile](#이진규의-profile)
  ...
  - [4. Project](#4-project)
    ...
    - [4-4. 사내 광고 데이터 수집 및 시각화 프로젝트](#4-4-사내-광고-데이터-수집-및-시각화-프로젝트)
...
- 프로젝트 기본 정보
  ...
  - 프로젝트 구성 인원 : 1명
    - 사수나 실무 담당 팀장이 없어 데이터 수집부터 보고서 작성에 이르는 모든 과정을 혼자 진행하였으며, 실무 지식이 있는 사내 대표이사의 간헐적인 피드백만으로 지시사항 접수 및 수정을 진행함
...
- 프로젝트 성과
  ...
  - 각 차원에 대한 비교 분석으로 보다 고도화된 인사이트의 도출출
...
- 프로젝트의 한계
  ...
  - DB 미사용
    - 데이터 규모가 크지 않아 JSON 파일 형식으로 데이터를 수집
