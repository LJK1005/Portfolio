- [이진규의 Profile](#이진규의-profile)
  ...
  - [2. Skill (Language \& Data)](#2-skill-language--data)
    ...
    - [2.4. etc](#24-etc)
      - [2.4.1. Streamlit 기반 웹 API 구현](#241-streamlit-기반-웹-api-구현)
...
- 고려사이버대학교 대학원 융합정보학과(석사) 재학 중
  - 재학기간 : 2025-02 ~ 재학 중
  - 데이터 관련 직무에 종사하면서 관련 지식을 더욱 개발하고 공적으로 인증되는 학위를 취득하기 위해 원격 대학원에 입학하여 직장 생활과 학업 생활을 병행하고 있습니다. 매 과목과 수업을 흥미를 가지고 임하고 있으며, 원격 강의는 물론 실시간 온/오프라인 세미나에 정기적으로 참가하여 교수진 및 원우들과의 교류를 이어나가고 있습니다.
...
- 기본 학습 정보
  ...
  - 습득방법 : 독학, 현업 종사
- 상세 보유기술 요약
  - 데이터 원본으로부터 로드하여 Power Query 를 이용한 데이터 전처리
...
생성형 AI를 이용한 챗봇은 이제 현업에서 필수적인 역량 중 하나로 지식 습득, 정보 요약, 의견 제시 등으로 업무 보조용으로 활용하고 있습니다.
