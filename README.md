...
- [이진규의 Profile](#이진규의-profile)
  ...
  - [3. Skill (Environment)](#3-skill-environment)
    ...
    - [3.2. Linux](#32-linux)
      ...
      - [3.2.4. 분산 처리 시스템](#324-분산-처리-시스템)
    - [3.3 클라우드 플랫폼](#33-클라우드-플랫폼)
      - [3.3.1 Microsoft Azure](#331-microsoft-azure)
      - [3.3.2 Google Cloud Platform (GCP)](#332-google-cloud-platform-gcp)
    - [3.4. etc](#34-etc)
      - [3.4.1. 개인 개발환경 구축](#341-개인-개발환경-구축)
      - [3.4.2. 사내 협업 소프트웨어](#342-사내-협업-소프트웨어)
  - [4. Project](#4-project)
